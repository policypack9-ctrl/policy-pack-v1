...
1. **Research-Assisted Draft Generation**: The app first assembles a research summary from either live model output or built-in compliance context, then uses that summary to draft the final Markdown document.
